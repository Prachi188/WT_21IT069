let text='{"employees":['+
           '{"firstName":"Prachi", "lastName":"Kotak"},'+
            '{"firstName":"Sweni", "lastName":"Thakker"},'+
            '{"firstName":"Khushi", "lastName":"Tanna"}]}';
        ...
        let student='{"name":"prachi", "age":18, "city":"Palanpur"}';
        ...
        let student2='{name:"prachi", age:18, city:"Palanpur"}';
